...
public class Intent implements Parcelable, Cloneable {
   ...
   /**
    ...
    static final public String intent_action="action";
    static final public String intent_data="data";
    static final public String intent_categories="categories";
    static final public String intent_bundle="bundle";
    static final public String intent_extra="extra";
    static final public String intent_byteExtra="byteExtra";
    static final public String intent_byteArrayExtra = "byteArrayExtra";
    static final public String intent_charArrayExtra = "charArrayExtra";
    static final public String intent_charExtra = "charExtra";
    static final public String intent_bundleExtra = "bundleExtra";
    static final public String intent_booleanExtra = "booleanExtra";
    static final public String intent_booleanArrayExtra = "booleanArrayExtra";
    static final public String intent_dataString = "dataString";
    static final public String intent_floatArrayExtra = "floatArrayExtra";
    static final public String intent_flags = "flags";
    static final public String intent_floatExtra = "floatExtra";
    static final public String intent_intArrayExtra = "intArrayExtra";
    static final public String intent_intExtra = "intExtra";
    static final public String intent_integerArrayListExtra = "ntegerArrayListExtra";
    static final public String intent_stringExtra = "stringExtra";
    static final public String intent_type = "type";
    static final public String intent_parseUri = "parseUri";
    static final public String intent_parseIntent = "parseIntent";
    ...
    public String getAction() {
        // Taint.log("intentGet-action: "+mAction);
        return mAction;
    }
    ...
    public Uri getData() {
        ...
        String str = null;
        if(mData!=null) {
            Taint.addTaintString(mData.toString(), Taint.intent_data);
            str = mData.toString();
        }
        // Taint.log("intentGet-data: "+str);
        return mData;
    }
    ...
    public String getScheme() {
        ...
        if(mData!=null)
            str=mData.getScheme();
        // Taint.log("intentGet-scheme: "+str);
    ...
    public String getType() {
        // Taint.log("intentGet-type: "+mType);
        return mType;
    }
    ...
    public boolean hasCategory(String category) {
        ...
        if(mCategories!=null&&mCategories.contains(category))
            str = "true";
        // Taint.log("intentGet-hasCategory: "+category+"-"+str);
    ...
    public Set<String> getCategories() {
        // Taint.log("intentGet-getCategories: yes");
        return mCategories;
    }
    ...
    public boolean hasExtra(String name) {
        String str="false";
        if(mExtras != null && mExtras.containsKey(name))
            str = "true";
        // Taint.log("intentGet-hasExtra: "+name+str);
    ...
    public boolean getBooleanExtra(String name, boolean defaultValue) {
        if(mExtras!=null) {
            Taint.addTaintBoolean(mExtras.getBoolean(name, defaultValue),Taint.intent_booleanExtra);
        }
    ...
    public byte getByteExtra(String name, byte defaultValue) {
        if(mExtras!=null) Taint.addTaintByte(mExtras.getByte(name, defaultValue),Taint.intent_byteExtra);
        return mExtras == null ? defaultValue :
    ...
    public short getShortExtra(String name, short defaultValue) {
        if(mExtras!=null) Taint.addTaintShort(mExtras.getShort(name, defaultValue),Taint.intent_shortExtra);
        return mExtras == null ? defaultValue :
    ...
    public char getCharExtra(String name, char defaultValue) {
        if(mExtras!=null) Taint.addTaintChar(mExtras.getChar(name, defaultValue),Taint.intent_charExtra);
        return mExtras == null ? defaultValue :
    ...
    public int getIntExtra(String name, int defaultValue) {
        if(mExtras!=null) Taint.addTaintInt(mExtras.getInt(name, defaultValue),Taint.intent_intExtra);
        return mExtras == null ? defaultValue :
    ...
    public long getLongExtra(String name, long defaultValue) {
        if(mExtras!=null) Taint.addTaintLong(mExtras.getLong(name, defaultValue),Taint.intent_longExtra);
        return mExtras == null ? defaultValue :
    ...
    public float getFloatExtra(String name, float defaultValue) {
        if(mExtras!=null) Taint.addTaintFloat(mExtras.getFloat(name, defaultValue),Taint.intent_floatExtra);
        return mExtras == null ? defaultValue :
    ...
    public double getDoubleExtra(String name, double defaultValue) {
        if(mExtras!=null) Taint.addTaintDouble(mExtras.getDouble(name, defaultValue),Taint.intent_douleExtra);
        return mExtras == null ? defaultValue :
    ...
    public String getStringExtra(String name) {
        if(mExtras==null || mExtras.size()==0 || mExtras.getString(name)==null ){
            return null;
        }
        String value = mExtras.getString(name);
//        Taint.taintDataOutIntent(value);
        String tag = Taint.intentTaintLeak(value);
        if(tag == null){
        	Taint.addTaintString(value,Taint.intent_stringExtra);
        }
        // Taint.log("receiverLeak-intent: stringExtra-"+tag);
        // Taint.log("intentGet-stringExtra:"+value);
        return value;
    ...
    public CharSequence getCharSequenceExtra(String name) {
        if(mExtras!=null) Taint.addTaintString(mExtras.getString(name),Taint.intent_stringExtra);
    ...
    public ArrayList<Integer> getIntegerArrayListExtra(String name) {
        if(mExtras!=null) Taint.addTaintObjectArray(mExtras.getIntegerArrayList(name).toArray(),Taint.intent_integerArrayListExtra);
    ...
    public ArrayList<String> getStringArrayListExtra(String name) {
        if(mExtras!=null) Taint.addTaintObjectArray(mExtras.getStringArrayList(name).toArray(),Taint.intent_stringArrayListExtra);
    ...
    public ArrayList<CharSequence> getCharSequenceArrayListExtra(String name) {
        if(mExtras!=null) Taint.addTaintObjectArray(mExtras.getCharSequenceArrayList(name).toArray(),Taint.intent_charSequenceArrayList);
    ...
    public boolean[] getBooleanArrayExtra(String name) {
        if(mExtras!=null) Taint.addTaintBooleanArray(mExtras.getBooleanArray(name),Taint.intent_booleanArrayExtra);
    ...
    public byte[] getByteArrayExtra(String name) {
        if(mExtras!=null) Taint.addTaintByteArray(mExtras.getByteArray(name),Taint.intent_byteArrayExtra);
    ...
    public short[] getShortArrayExtra(String name) {
        if(mExtras!=null) Taint.addTaintShortArray(mExtras.getShortArray(name),Taint.intent_shortArrayExtra);
    ...
    public char[] getCharArrayExtra(String name) {
        if(mExtras!=null) Taint.addTaintCharArray(mExtras.getCharArray(name),Taint.intent_charArrayExtra);
    ...
    public int[] getIntArrayExtra(String name) {
        if(mExtras!=null) Taint.addTaintIntArray(mExtras.getIntArray(name),Taint.intent_intArrayExtra);
    ...
    public long[] getLongArrayExtra(String name) {
        if(mExtras!=null) Taint.addTaintLongArray(mExtras.getLongArray(name),Taint.intent_longArrayExtra);
    ...
    public float[] getFloatArrayExtra(String name) {
        if(mExtras!=null) Taint.addTaintFloatArray(mExtras.getFloatArray(name),Taint.intent_floatArrayExtra);
    ...
    public double[] getDoubleArrayExtra(String name) {
        if(mExtras!=null) Taint.addTaintDoubleArray(mExtras.getDoubleArray(name),Taint.intent_doubleArrayExtra);
    ...
    public String[] getStringArrayExtra(String name) {
        if(mExtras!=null) Taint.addTaintObjectArray(mExtras.getStringArray(name),Taint.intent_stringArrayListExtra);
    ...
    public CharSequence[] getCharSequenceArrayExtra(String name) {
        if(mExtras!=null) Taint.addTaintObjectArray(mExtras.getCharSequenceArray(name),Taint.intent_charSequenceArrayList);
     ...
     */
    public int getFlags() {
        Taint.addTaintInt(mFlags,Taint.intent_flags);
        return mFlags;
    }
    ...
    public Intent putExtra(String name, boolean value) {
        ...
        boolean taintValue = value;
        Taint.addTaintBoolean(taintValue,Taint.intent_booleanExtra);
        mExtras.putBoolean(name, taintValue);
    ...
    public Intent putExtra(String name, byte value) {
        ...
        byte taintValue = value;
        Taint.addTaintByte(taintValue,Taint.intent_byteExtra);
        mExtras.putByte(name, taintValue);
        return this;
    }
    ...
    public Intent putExtra(String name, char value) {
        ...
        char taintValue = value;
        Taint.addTaintChar(taintValue,Taint.intent_charExtra);
        mExtras.putChar(name, taintValue);
        return this;
    }
    ...
    public Intent putExtra(String name, short value) {
        ...
        short taintValue = value;
        Taint.addTaintShort(taintValue,Taint.intent_shortExtra);
        mExtras.putShort(name, taintValue);
        return this;
    }
    ...
    public Intent putExtra(String name, int value) {
        ...
        int taintValue = value;
        Taint.addTaintInt(taintValue,Taint.intent_intExtra);
        mExtras.putInt(name, taintValue);
        return this;
    }
    ...
    public Intent putExtra(String name, long value) {
        ...
        long taintValue = value;
        Taint.addTaintLong(taintValue,Taint.intent_longExtra);
        mExtras.putLong(name, taintValue);
        return this;
    }
    ...
    public Intent putExtra(String name, float value) {
        ...
        float taintValue = value;
        Taint.addTaintFloat(taintValue,Taint.intent_floatExtra);
        mExtras.putFloat(name, taintValue);
        return this;
    }
    ...
    public Intent putExtra(String name, double value) {
        ...
        double taintValue = value;
        Taint.addTaintDouble(taintValue,Taint.intent_douleExtra);
        mExtras.putDouble(name, taintValue);
        return this;
    }
    ...
    public Intent putExtra(String name, String value) {
        ...
        String taintValue = value;
        if(taintValue!=null){

            int tag = Taint.getTaintString(taintValue);
            String taintString = Taint.whatTaintInSetIntent(tag);
            if(taintString!=null) {
                String NEWTAG = "ACIDroid";
                Taint.log("intentTaint: "+taintString);
                Taint.log("intentTaint-content: "+value);
            }
            Taint.taintDataOutIntent(taintValue);
        }


        mExtras.putString(name, taintValue);
        return this;
    }
    ...
    public Intent putExtra(String name, CharSequence value) {
        ...
        CharSequence taintValue = value;
        Taint.addTaintString(taintValue.toString(),Taint.intent_stringExtra);
        mExtras.putCharSequence(name, taintValue);
        return this;
    }
    ...
    public Intent putExtra(String name, boolean[] value) {
        ...
        boolean[] taintValue = value;
        Taint.addTaintBooleanArray(taintValue,Taint.intent_booleanArrayExtra);
        mExtras.putBooleanArray(name,taintValue);
        return this;
    }
    ...
    public Intent putExtra(String name, byte[] value) {
        ...
        byte[] taintValue = value;
        Taint.addTaintByteArray(taintValue,Taint.intent_byteArrayExtra);
        mExtras.putByteArray(name,taintValue);
        return this;
    }
    ...
    public Intent putExtra(String name, short[] value) {
        ...
        short[] taintValue = value;
        Taint.addTaintShortArray(taintValue,Taint.intent_shortArrayExtra);
        mExtras.putShortArray(name,taintValue);
        return this;
    }
    ...
    public Intent putExtra(String name, char[] value) {
        ...
        char[] taintValue = value;
        Taint.addTaintCharArray(taintValue,Taint.intent_charArrayExtra);
        mExtras.putCharArray(name,taintValue);
        return this;
    }
    ...
    public Intent putExtra(String name, int[] value) {
        ...
        int[] taintValue = value;
        Taint.addTaintIntArray(taintValue,Taint.intent_intArrayExtra);
        mExtras.putIntArray(name,taintValue);
        return this;
    }
    ...
    public Intent putExtra(String name, long[] value) {
        ...
        long[] taintValue = value;
        Taint.addTaintLongArray(taintValue,Taint.intent_longArrayExtra);
        mExtras.putLongArray(name,taintValue);
        return this;
    }
    ...
    public Intent putExtra(String name, float[] value) {
        ...
        float[] taintValue = value;
        Taint.addTaintFloatArray(taintValue,Taint.intent_floatArrayExtra);
        mExtras.putFloatArray(name,taintValue);
        return this;
    }
    ...
    public Intent putExtra(String name, double[] value) {
        ...
        double[] taintValue = value;
        Taint.addTaintDoubleArray(taintValue,Taint.intent_doubleArrayExtra);
        mExtras.putDoubleArray(name,taintValue);
        return this;
    }
    ...
    public Intent putExtra(String name, String[] value) {
        ...
        String[] taintValue = value;
        Taint.addTaintObjectArray(taintValue,Taint.intent_booleanArrayExtra);
        mExtras.putStringArray(name,taintValue);
        return this;
    }
