...
public class NetworkInfo implements Parcelable {
    ...
    public int getType() {
        synchronized (this) {
            Taint.addTaintInt(mSubtype,Taint.TAINT_network_type);
            return mNetworkType;
        }
    }
    ...
    public int getSubtype() {
        synchronized (this) {
            Taint.addTaintInt(mSubtype,Taint.TAINT_network_subtype);
            return mSubtype;
        }
    }
    ...
    public String getTypeName() {
        synchronized (this) {
            Taint.addTaintString(mSubtypeName,Taint.TAINT_network_type);
            return mTypeName;
        }
    }
    ...
    public String getSubtypeName() {
        synchronized (this) {
            Taint.addTaintString(mSubtypeName,Taint.TAINT_network_subtype);
            return mSubtypeName;
        }
    }
    ...
    public boolean isConnectedOrConnecting() {
        synchronized (this) {
            boolean state = mState == State.CONNECTED || mState == State.CONNECTING;
            Taint.addTaintBoolean(state, Taint.TAINT_network_state);
            return state;
        }
    }
    ...
    public boolean isConnected() {
        synchronized (this) {
            boolean state = mState == State.CONNECTED;
            Taint.addTaintBoolean(state, Taint.TAINT_network_state);
            return state;
        }
    }
