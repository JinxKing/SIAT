...
// begin WITH_TAINT_TRACKING
        if(taint_ == Taint.TAINT_CLEAR)
            return Taint.addTaintDouble(mCursor.getDouble(columnIndex), Taint.TAINT_provider_query);
...
// begin WITH_TAINT_TRACKING
        if(taint_ == Taint.TAINT_CLEAR)
            return Taint.addTaintFloat(mCursor.getFloat(columnIndex), Taint.TAINT_provider_query);
...
// begin WITH_TAINT_TRACKING
        if(taint_ == Taint.TAINT_CLEAR)
            return Taint.addTaintInt(mCursor.getInt(columnIndex),Taint.TAINT_provider_query);
...
// begin WITH_TAINT_TRACKING
        if(taint_ == Taint.TAINT_CLEAR)
            return Taint.addTaintLong(mCursor.getLong(columnIndex), Taint.TAINT_provider_query);
...
// begin WITH_TAINT_TRACKING
        if(taint_ == Taint.TAINT_CLEAR)
            return Taint.addTaintShort(mCursor.getShort(columnIndex), Taint.TAINT_provider_query);
...
// begin WITH_TAINT_TRACKING
        ...
        if(taint_ != Taint.TAINT_CLEAR) {
            ...
            Taint.addTaintString(retString,Taint.TAINT_provider_query);
        }
// end WITH_TAINT_TRACKING
        return retString;
    }
