...
final class ActivityStack {
    ...
    final boolean realStartActivityLocked(ActivityRecord r,
        ...
        if(app!=null){
            ...
            Taint.log("receiver-packageName: "+pid+"-"+app.info.packageName);
            Taint.log("receiver-componentName: "+pid+"-"+app.stringName+"-"+app.info.className+app.shortStringName+app.info.className+app.info.name);
        }
    ...
    private void outputMyLog(IApplicationThread caller,ActivityInfo aInfo,int callingPid){
        final String NEWTAG = "ACIDroid";
        if(caller == null || aInfo == null){
            return;
        }
        ProcessRecord callerApp = mService.getRecordForAppLocked(caller);
        String mypid = String.valueOf(callerApp.pid);
        Taint.log("ifilterMatch-package: "+mypid+"-"+aInfo.applicationInfo.packageName);
        Taint.log("ifliterMatch-component: "+ mypid+"-"+aInfo.name);
    ...
    final int startActivityMayWait(IApplicationThread caller, int callingUid,
        ...
        synchronized (mService) {
            ...
            outputMyLog(caller,aInfo,callingPid);
