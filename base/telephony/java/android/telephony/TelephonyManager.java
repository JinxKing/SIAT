...
public class TelephonyManager {
    ...
    public String getDeviceId() {
        try {
            Taint.addTaintString(getSubscriberInfo().getDeviceId(),Taint.TAINT_DEVICEID);
            Taint.log("getDeviceId!!!!!!!!!!!!!!!!!!!!!!!!!!");
    ...
    public String getSimSerialNumber() {
        try {
            Taint.addTaintString(getSubscriberInfo().getIccSerialNumber(),Taint.TAINT_SIMSERIANUMBER);
    ...
    public String getSubscriberId() {
        try {
            Taint.addTaintString(getSubscriberInfo().getSubscriberId(),Taint.TAINT_SUBSCRIBERID);
    ...
    public String getLine1Number() {
        try {
            Taint.addTaintString(getSubscriberInfo().getLine1Number(),Taint.TAINT_PHONE_NUMBER);
