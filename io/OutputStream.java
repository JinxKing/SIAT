...
public abstract class OutputStream implements Closeable, Flushable {
    ...
    void taintLeakByOutputStream(byte[] data){
        String NEWTAG = "ACIDroid";
        String leakTag = "taintLeak: OutputStream-";
        int tag = Taint.getTaintByteArray(data);
        if(tag == Taint.intent_byteArrayExtra){
            Taint.log(leakTag+"intent_byteArrayExtra");
        }
    ...
    public void write(byte[] buffer) throws IOException {
        taintLeakByOutputStream(buffer);
